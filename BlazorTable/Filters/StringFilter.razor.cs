...
namespace BlazorTable
{
    public partial class StringFilter<TableItem> : IFilter<TableItem>
    {
        ...
        public Expression<Func<TableItem, bool>> GetFilter()
        {
            ...
            if (Condition != StringCondition.IsNullOrEmpty && Condition != StringCondition.IsNotNulOrEmpty &&
                string.IsNullOrEmpty(FilterText)) return null;
        ...
        protected override void OnInitialized()
        {
            if (Column.Type == typeof(string))
            {
                ...
                if (Column.Filter != null)
                {
                    ...
                    var method = Column.Filter.Body;

                    if (method is BinaryExpression binary) method = binary.Right;
